...
export default function ProfilrSection({ isLogin }) {
    return (
        <>
            ...
            <aside id="logo-sidebar" className="fixed  left-0 w-60 shadow-xl border-t-2  transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-black">
                    {isLogin ? <a href="https://flowbite.com/" className="flex items-center ps-2.5">
                        <img src="https://flowbite.com/docs/images/logo.svg" className="h-6 me-3 sm:h-7" alt="Flowbite Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
                    </a> : <Btn className="m-5" content="Login/Singup" />}
                        ...
                        {isLogin && profileContentList.map((Links)=>(
                            <li key={Links.id}>
                                <a href={Links.url} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span className="ms-3">{Links.text}</span>
                                </a>
                        </li>
                        ))}
